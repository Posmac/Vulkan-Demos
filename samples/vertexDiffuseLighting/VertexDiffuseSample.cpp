#include "VertexDiffuseSample.h"

namespace vk
{
    bool VertexDiffuseSample::Initialize(WindowParameters& windowParams,
        ...
        std::vector<const char*> deviceExtensions)
    {
        ...
        if (!GetBinaryFileContents("shaders/vertexDiffuseLighting/shaderSPIRV.vert.txt", vertexShader))
        {
            return false;
        }
        ...
        if (!GetBinaryFileContents("shaders/vertexDiffuseLighting/shaderSPIRV.frag.txt", fragmentShader))
        {
            return false;
        }
    ...
    bool VertexDiffuseSample::Resize()
    {
        return true;
    }

    void VertexDiffuseSample::Destroy()
    {
